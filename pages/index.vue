...
const { data, status, execute } = useFetch("/api/movies/discover", {
  immediate: false,
  transform: (data) => {
  ...
  <div class="max-w-2xl mx-auto">
    <section>
      <div class="mt-9 mb-2">
        ...
        >
          Enjoy top movies without restrictions using
          <span class="text-blue-600 dark:text-blue-500 uppercase"
            >our premium plan,
          </span>
          or take advantage of the generous
          <span class="text-blue-600 dark:text-blue-500 uppercase"
            >free tier
          </span>
    ...
    <section>
      <div class="mt-9 mb-2">
        <h1
          class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-3xl dark:text-white text-center"
        >
          Stream top TV series without restrictions using
          <span class="text-blue-600 dark:text-blue-500 uppercase"
            >our premium plan,
          </span>
          or take advantage of the generous
